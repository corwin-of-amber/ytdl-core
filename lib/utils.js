...
const AGENT = require("./agent-null");
...
exports.request = async (url, options = {}) => {
  ...
  if (code.startsWith("2")) {
    if (req.headers.get("content-type").startsWith("application/json")) return req.json();
    return req.text();
  }
  if (code.startsWith("3")) return exports.request(req.headers.get('location'), options);
